...
exports.editJobValidation = void 0;
const joi_1 = __importDefault(require("joi"));
exports.editJobValidation = joi_1.default.object({
    ...
    publish: joi_1.default.boolean().optional(),
    ...
    benefits: joi_1.default.array().items(joi_1.default.object({
        ...
        _id: joi_1.default.string().allow(null).optional(),
    })).optional(),
