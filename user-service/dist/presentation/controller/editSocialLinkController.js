...
const editSocialLinkController = (dependencies) => {
    ...
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const { value, error } = socialLinkValidation_1.socialLinkValidation.validate(datas.data);
            if (error) {
                return next(errorResponse_1.default.badRequest(error.message));
            }
            const { id, data } = datas;
            const editedsociallink = yield editSocialLinkUseCase(dependencies).execute(id, data);
            if (!editedsociallink) {
                return next(errorResponse_1.default.forbidden("Error occured in editng social links   of user"));
            }
            else {
...
exports.editSocialLinkController = editSocialLinkController;
