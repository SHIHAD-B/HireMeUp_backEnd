...
const addExperience = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!data) {
            return null;
        }
        ...
        const result = yield userSchema_1.default.updateOne({ _id: id }, { $push: { experiences: data } }, { new: true });
