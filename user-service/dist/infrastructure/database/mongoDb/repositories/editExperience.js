...
const editExperience = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!data) {
            return null;
        }
        ...
        const result = yield userSchema_1.default.updateOne({ _id: id, "experiences._id": data._id }, { $set: { "experiences.$": data } }, { new: true });
