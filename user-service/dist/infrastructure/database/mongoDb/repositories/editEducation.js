...
const editEducation = (id, data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!data) {
            return null;
        }
        ...
        const result = yield userSchema_1.default.updateOne({ _id: id, "education._id": data._id }, { $set: { "education.$": data } }, { new: true });
