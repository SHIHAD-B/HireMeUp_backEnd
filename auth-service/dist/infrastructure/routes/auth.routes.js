...
const authRoutes = (dependencies) => {
    const { signinUser, signupUser, logout, forgot, companySignup, signupWithGoogle, companySignin, adminSignin, companyForgot } = (0, controllers_1.controllers)(dependencies);
