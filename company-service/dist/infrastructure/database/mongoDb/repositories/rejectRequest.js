...
const rejectRequest = (data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!data) {
            return null;
        }
        ...
        const updateResult = yield requestSchema_1.default.updateOne({ email: data.email }, { $set: { approval: "rejected" } });
